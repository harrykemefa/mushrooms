...
$query = $db->query("SELECT * FROM seekers WHERE email = '$email'");
...
$user_check_Count = mysqli_num_rows($user_check_query);
   ...
   if ($userCount < 1) {
		 ...
		 $InsertSql = $db->query("INSERT INTO seekers (email, full_name, phone, space_type, hood, bed, budget, move_date) VALUES ('$email', '$full_name', '$phone', '$space_type', '$hood', '$bed', '$budget', '$new_date')");
